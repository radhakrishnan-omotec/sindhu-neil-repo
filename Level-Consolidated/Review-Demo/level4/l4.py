...
exercise_image = pygame.image.load("Images/exercise.png")
exercise_rect = exercise_image.get_rect()

breakfast_image = pygame.image.load("Images/breakfast.jpg")
breakfast_rect = breakfast_image.get_rect()

lunch_image = pygame.image.load("Images/lunch.jpg")
lunch_rect = lunch_image.get_rect()

nap_image = pygame.image.load("Images/nap.jpg")
nap_rect = nap_image.get_rect()

walk_image = pygame.image.load("Images/walk.jpg")
walk_rect = walk_image.get_rect()

dinner_image = pygame.image.load("Images/dinner.jpg")
