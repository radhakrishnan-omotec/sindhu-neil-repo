...
occasion_images = {
    "birthday": pygame.image.load("Images/HB1.jpg"),
    "holiday": pygame.image.load("Images/vacay1.jpg"),
    "wedding": pygame.image.load("Images/Wed1.jpg"),
    "easter": pygame.image.load("Images/easter1.jpg"),
    "christmas": pygame.image.load("Images/christmas.jpg"),
    "friends":pygame.image.load("Images/friends21.png"),
}
...
dragging, dragged_image, offset_x, offset_y, message
