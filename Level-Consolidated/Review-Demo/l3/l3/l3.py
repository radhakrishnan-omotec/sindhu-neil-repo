...
wall_image = pygame.image.load("l3/Images/wall.png")
...
occasion_images = {
    "birthday": pygame.image.load("l3/Images/HB1.jpg"),
    "holiday": pygame.image.load("l3/Images/vacay1.png"),
    "wedding": pygame.image.load("l3/Images/Wed1.jpg"),
    "easter": pygame.image.load("l3/Images/easter1.jpg"),
    "christmas": pygame.image.load("l3/Images/christmas.png"),
    "friends":pygame.image.load("l3/Images/friends21.png"),
}
